 ...
 * @param muteAffected Build type locator (for finding out if this test is affected by mutes in build type).
 * @param name 
...
class TestLocator(
    ...
    @SerializedName("muteAffected") val muteAffected: String? = null,
    @SerializedName("name") val name: String? = null,
    @SerializedName("start") val start: Int? = null
) : LocatorEntity() {
    @Transient private val classModelName: String = "TestLocator"
